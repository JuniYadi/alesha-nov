...
export const authMigrationsBundle: Migration[] = [
  ...
  {
    id: "003_create_auth_magic_link_tokens",
    sql: `
  ...
  {
    id: "005_create_auth_oauth_accounts",
    sql: `
  ...
  {
    id: "006_create_auth_password_reset_tokens",
    sql: `
  ...
  {
    id: "007_create_auth_email_verification_tokens",
    sql: `
