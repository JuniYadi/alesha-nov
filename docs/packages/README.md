...
|---|---|---|---|
| [@alesha-nov/config](config) | DB type resolver, SQL client factory, migration runner, `JWTConfig` + `SessionConfig` types, OAuth env resolver, auth migration bundle export | Session config env resolver, magic-link/email config resolver | [#21](https://github.com/JuniYadi/alesha-nov/issues/21), [#22](https://github.com/JuniYadi/alesha-nov/issues/22) |
